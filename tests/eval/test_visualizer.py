...
class TestVisualizer:
    ...
    def test_plot_training_curves(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_loss_perplexity(
                self.training_data, save_path=output_path
            )
    ...
    def test_plot_training_curves_invalid_data(self) -> None:
        ...
        with pytest.raises(
            ValueError, match="Missing required keys in training data"
        ):
            self.visualizer.plot_loss_perplexity(invalid_data, "test.png")
    ...
    def test_plot_training_curves_empty_data(self) -> None:
        ...
        with pytest.raises(ValueError, match="Training data cannot be empty"):
            self.visualizer.plot_loss_perplexity(empty_data, "test.png")
    ...
    def test_plot_evaluation_metrics(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_evaluation_metrics(
                self.evaluation_data, save_path=output_path
            )
    ...
    def test_plot_evaluation_metrics_bleu_only(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_evaluation_metrics(
                bleu_data, save_path=output_path
            )
    ...
    def test_plot_evaluation_metrics_rouge_only(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_evaluation_metrics(
                rouge_data, save_path=output_path
            )
    ...
    def test_plot_hyperparameter_comparison(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_hyperparameter_search(
                hyperparam_data, save_path=output_path
            )
    ...
    def test_create_summary_plot_no_data(self) -> None:
        ...
        with pytest.raises(
            ValueError, match="At least one dataset must be provided"
        ):
            self.visualizer.create_summary_report(save_path="test.png")
    ...
    def test_plot_error_handling(self) -> None:
        ...
        with pytest.raises(OSError):
            self.visualizer.plot_loss_perplexity(
                self.training_data, save_path="/invalid/path/plot.png"
            )
    ...
    def test_plot_data_integrity(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_loss_perplexity(
                corrupted_data, save_path=output_path
            )
    ...
    def test_plot_with_single_data_point(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_loss_perplexity(
                single_point_data, save_path=output_path
            )
    ...
    def test_plot_with_large_dataset(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.visualizer.plot_loss_perplexity(
                large_data, save_path=output_path
            )
