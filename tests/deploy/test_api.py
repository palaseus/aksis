...
from aksis.deploy.api import APIServer, ChatRequest, GenerateRequest, HealthResponse
...
class TestAPIServer:
    ...
    def test_chat_endpoint_success(self, mock_generator):
        ...
        assert server.generator.generate.return_value == "Hello! How can I help you today?"
    ...
    def test_generate_endpoint_success(self, mock_generator):
        ...
        assert server.generator is not None
        assert server.generator.generate.return_value == "Once upon a time, there was a..."
    ...
    def test_chat_endpoint_invalid_request(self) -> None:
        ...
        # Test request validation - empty message should be allowed by Pydantic
        # but we can test other validation scenarios
        try:
            request = ChatRequest(message="")  # This might be allowed
    ...
    def test_generate_endpoint_invalid_request(self) -> None:
        ...
        # Test request validation - empty prompt might be allowed by Pydantic
        try:
            request = GenerateRequest(prompt="")  # This might be allowed
