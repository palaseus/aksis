...
class DistributedTrainer:
    ...
    def wrap_model(
        self, model: nn.Module, use_distributed: bool = False
    ) -> nn.Module:
    ...
    def scale_loss(
        self, loss: torch.Tensor, scaler: Optional[torch.cuda.amp.GradScaler]
    ) -> torch.Tensor:
    ...
    def unscale_gradients(
        self, model: nn.Module, scaler: Optional[torch.cuda.amp.GradScaler]
    ) -> None:
